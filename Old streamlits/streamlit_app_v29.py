...
def generate_ideas_openai(
    ...
    8. Vermijd politieke of controversiële onderwerpen en zorg dat de trends logisch passen bij de niche. 
       ...
       low_budget_rule = "9. **Low budget:** elk script mag maximaal 1 filmlocatie en 1 acteur bevatten." if low_budget else ""
...
def main():
    ...
    with st.sidebar:
        ...
        low_budget = st.checkbox(
            ...
            help="ideeën bevallen slechts één locatie en acteur"  # per your exact text
        )
    ...
    manual_products_df = st.data_editor(
        ...
        num_rows="dynamic",
        width="stretch",
        key="manual_push_products"   # ✅ renamed key (was "product_push_table")
    )
